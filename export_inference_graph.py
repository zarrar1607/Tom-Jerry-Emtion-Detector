...
Example Usage:
--------------
python export_inference_graph.py \ --input_type image_tensor \ --pipeline_config_path training/ssd_mobilenet_v1_pets.config \ --trained_checkpoint_prefix training/model.ckpt- \ --output_directory TRM_inference_graph
...
flags.DEFINE_string('input_shape', None,
                    ...
                    '`[None, None, None, 3]`.')
flags.DEFINE_string('pipeline_config_path', 'training/ssd_mobilenet_v1_pets.config',
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', 'training/model.ckpt-105711',
                    'Path to trained checkpoint, typically of the form '
                    'path/to/model.ckpt')
flags.DEFINE_string('output_directory', 'TJ_inference_graph', 'Path to write outputs.')
